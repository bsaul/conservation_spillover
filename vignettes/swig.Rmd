...
```{tikz, fig.cap = "swig", fig.ext='png',fig.width=8}
...
\node[name=li2, right=35mm of li1, ell, shape=ellipse]{$L_{i2}$}; 
\node[name=ai2, right=10mm of yi1, shape=swig hsplit]{
  \nodepart{upper}{$A_{i2}$}
  \nodepart{lower}{$a_{i2}$} };
\node[name=atildei2, right=65mm of dummyi1, ell, draw=red,
      shape=ellipse]{$\tilde{a}_{i2}$};
\node[name=yi2, right=25mm of ai2, ell, 
      shape=ellipse]{$Y_{i1}(a_{i1}, \tilde{a}_{i1}, a_{i2}, \tilde{a}_{i2})$}; 
